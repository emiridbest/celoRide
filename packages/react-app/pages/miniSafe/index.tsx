    ...
    <div className="container mx-auto p-4 lg:p-0">
      ...
      <div className="flex flex-col lg:flex-row text-sm ">
        <aside className="w-full lg:w-1/3 p-4">
          <div className="bg-gradient-to-br from-prosperity to-prosperity bg-opacity-75 backdrop-filter backdrop-blur-lg border border-prosperity-300 rounded-lg shadow-lg">
            <div className="p-6">
              <h3 className="font-semibold text-black mb-4 text-lg">My Savings</h3>
              <div className="mb-4">
                <div className="flex justify-between items-center mb-2">
                  <span className="text-black-600"><CurrencyDollarIcon className="mr-2 text-black" />CELO:</span>
                  <span className="text-black text-2xl font-bold">{celoBalance} CELO</span>
                </div>
                <div className="flex justify-between items-center mb-2">
                  <span className="text-black-600"><CurrencyDollarIcon className="mr-2 text-black" />CUSD:</span>
                  <span className="text-black text-2xl font-bold">{CUSDBalance} CUSD</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-black-600"><CurrencyPoundIcon className="mr-2 text-black" />CPT:</span>
                  <span className="text-black text-2xl font-bold">{tokenBalance} CPT</span>
                </div>
              </div>
              <div>
                <label htmlFor="token-select" className="block text-black-600 mb-2">Select token you want to deposit</label>
                <select
                  id="token-select"
                  value={selectedToken}
        ...
        <main className="w-full lg:w-2/3 p-4">
          <div className="bg-prosperity p-6 rounded-lg shadow-md mb-4 bg-gradient-to-br from-prosperity to-prosperity bg-opacity-75 backdrop-filter backdrop-blur-lg border border-prosperity-300 rounded-lg shadow-lg">
            <div className="bg-prosperity p-6 rounded-lg shadow-md mb-4 bg-gradient-to-br from-prosperity to-prosperity bg-opacity-75 backdrop-filter backdrop-blur-lg border border-prosperity-300 rounded-lg shadow-lg">
              <h3 className="text-sm font-semibold text-black mb-2">Lock Up</h3>
              <form
                className="mb-4">
                <div className="mb-4">
                  <label className="text-sm font-light text-black mb-2" htmlFor="deposit-amount">Amount</label>
                  <label className="flex text-xs font-light text-black mb-2" htmlFor="deposit-amount">Approve amount before depositing...</label>
                  <input
                    type="number"
                    step="0.01"
                    value={depositAmount}
                    onChange={(e) => setDepositAmount(Number(e.target.value))}
                    className="border rounded px-4 py-2 w-full mb-2 text-black bg-prosperity"
                  />
                </div>
                <button
                  disabled={isApproved}
                ...
                >
                  {isWaitingTx ? <Loader alt /> : "Lock Up"}
                </button>
              </form>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md mb-4 bg-gradient-to-br from-prosperity to-prosperity bg-opacity-75 backdrop-filter backdrop-blur-lg border border-prosperity-300 rounded-lg shadow-lg">
