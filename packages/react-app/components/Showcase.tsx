  ...
  return (
    <div className='hidden lg:block bg-gypsum'>
      <h2 className="text-2xl font-bold mb-4">
        <div>Do more with your crypto with CeloRide</div>
      </h2>
      <div className="flex flex-wrap justify-around">
        ...
        <picture className="block cursor-pointer">
          ...
          <div className="text-base">CeloRide utilizes stable coins payment shielding you from crypto volatility</div>
        </div>
        <div className="w-full sm:w-1/2 lg:w-1/4 p-4">
          <picture className="block cursor-pointer">
          ...
          <div className="text-base">CeloRide is built for mobile, making crypto easy.</div>
        </div>
        <div className="w-full sm:w-1/2 lg:w-1/4 p-4">
          <picture className="block cursor-pointer">
          ...
          <div className="text-base">Your ride sharing experience</div>
        </div>
        <div className="w-full sm:w-1/2 lg:w-1/4 p-4">
          <picture className="block cursor-pointer">
